            ...
            <div className=" px-6 py-4 ">
                <div className="lg:flex lg:items-center lg:justify-between">
                    ...
                    <div className={`${isOpen ? 'block' : 'hidden'} lg:flex md:gap-5 lg:items-center lg:mx-8`}>
                        ...
                        <NavLink to={"/order/salad"} className={({ isActive, isPending }) => isActive ? "active text-red-600 hover:underline" : isPending ? "pending " : "block px-3 py-2 mt-2 text-[#2FA0D9] transition-colors duration-300 transform rounded-md lg:mt-0   hover:bg-gray-100 dark:hover:bg-gray-700"}>Order</NavLink>
                        {
